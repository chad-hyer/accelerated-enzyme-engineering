...
class AugmentedMLDEmodel():
    ...
    def __init__(self, training_data, test_data, wt_sequence, EC_file, Maestro_file, ESM_file):
        ...
        if self._test_data is not None:
            test_data = self._test_data#pd.read_excel(self._test_data_file, keep_default_na=False)
